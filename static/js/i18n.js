...
const RU = {
  ...
  'pair': 'пара',
  'preview weight': 'превью жирности',
  'render the real weighted shape on the server': 'построить настоящую форму с жирностью на сервере',
  'rendering…': 'строю…',
  'preview failed': 'превью не удалось',
